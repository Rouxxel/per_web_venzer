...
export const experience: ExperienceEntry[] = [
  {
    ...
    description:
      "Designed low and high-fidelity wireframes on Figma and implemented them in a React + TypeScript frontend that connected to a deployed Python backend. Maintained a component based architecture and clean integration with the REST API services to support concurrent users and AI features.",
    type: "work",
  },
  {
    ...
    description:
      "Developed Python-based backend software for processing high-frequency sensor data using Pandas, NumPy, Matplotlib and multithreading, focusing on OOP, performance, reliability and maintainability, adding Docker for deployment, a custom logger for longterm progress register, Git-based workflows for version control, CI/CD pipelines, linting for code quality and created/designed system architecture diagrams with draw.io for research and planning. Zeugnis available on request.",
    type: "work",
  },
  {
