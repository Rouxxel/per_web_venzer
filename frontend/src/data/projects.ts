...
export const projects_en: Project[] = [
  ...
  {
    title: "Langdrill - Educational platform (Stealth startup)",
  ...
  {
    title: "Envrad - Beware of all of your surroundings",
    image: "/images/envrad/logo_envrad_512.jpg",
    description:
      "Privacy-focused Flutter Android app that passively maps your nearby wireless environment with simultaneous BLE and Classic Bluetooth scanning plus Wi-Fi AP discovery. It tracks devices over time, smooths RSSI into qualitative proximity, correlates identities across randomized addresses and scores explainable suspicion with anomaly and possible-interference alerts; all fully on-device (Drift/SQLite, no cloud or account). There is also a plan to possibly add external Raspberry Pi modules over USB-C or Lightning for wider-spectrum sensing and better results.",
    tags: [
      "Flutter",
      "Dart",
      "Kotlin",
    ...
    classifications: ["Fullstack", "Mobile", "Privacy", "Personal", "Research/Experimental", "Standalone"],
    //github: "https://github.com/Rouxxel/simple-chat",
    //demo: "https://youtu.be/",
  },
  {
    title: "Lol Coach - Rift Rewind platform for coaching",
  ...
  {
    title: "TuneTools - Personalized music for your day",
  ...
  {
    title: "Fintech CheckAI - Financial Fact checker",
  ...
  {
    title: "Emotional Detection Deep Learning model",
  ...
  {
    title: "Drone sound detection Machine Learning models",
  ...
  {
    title: "Reusable code snippets in-repository",
  ...
  {
    title: "HelpVenz - Logistics and Aid for Venezuela",
  ...
  {
    title: "MAXergy app - Your green planer helper",
  ...
  {
    title: "Nothingness - Unity 2D arcade game",
  ...
  {
    title: "Pongilike - 2D multiplayer Pong Game",
  ...
  {
    title: "Atryon Chrome Extension - Your virtual try-on",
  ...
  {
    title: "Cogmerge - Collaboration developer tool",
  ...
  {
    title: "VERITAS protocol PPAVI - Privacy first",
  ...
  {
    title: "F1 penalty predictor - Anticipate stewards",
...
const projectDescriptionsEs: Record<string, string> = {
  ...
  "Envrad - Beware of all of your surroundings":
    "Aplicación Android enfocada en la privacidad, construida con Flutter, que observa pasivamente el entorno inalámbrico cercano: escaneo simultáneo BLE y Bluetooth Classic, descubrimiento de APs Wi-Fi, seguimiento de proximidad basado en RSSI, correlación de identidades entre direcciones MAC aleatorizadas y puntuación de sospecha explicable con alertas de anomalías y posible interferencia; todo completamente en el dispositivo (Drift/SQLite, sin nube ni cuenta). También hay un plan para añadir posiblemente módulos externos con Raspberry Pi por USB-C o Lightning para un espectro más amplio y mejores resultados.",
  ...
  "VERITAS protocol PPAVI - Privacy first":
...
const projectDescriptionsFr: Record<string, string> = {
  ...
  "Envrad - Beware of all of your surroundings":
    "Application Android axée sur la confidentialité, construite avec Flutter, qui observe passivement l'environnement sans fil à proximité : scan BLE et Bluetooth Classic simultanés, découverte de points d'accès Wi-Fi, suivi de proximité basé sur le RSSI, corrélation d'identités entre adresses MAC randomisées et score de suspicion explicable avec alertes d'anomalies et d'interférence possible; le tout entièrement sur l'appareil (Drift/SQLite, sans cloud ni compte). Il est également prévu d'ajouter éventuellement des modules externes Raspberry Pi via USB-C ou Lightning pour une couverture spectrale plus large et de meilleurs résultats.",
  "Lol Coach - Rift Rewind platform for coaching":
